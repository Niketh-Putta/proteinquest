    ...
    <SafeAreaView style={styles.safe} edges={embedded ? ['top'] : ['top', 'bottom']}>
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <Pressable onPress={() => setGoalsOpen(v => !v)} accessibilityRole="button"
            accessibilityState={{ expanded: goalsOpen }} style={{ paddingVertical: 22 }}>
            <Text style={{ color: colors.text, fontFamily: fonts.displayHeavy, fontSize: 18 }}>
              Goals & personal details {goalsOpen ? '−' : '+'}
            </Text>
            <Text style={{ color: colors.textSecondary, fontFamily: fonts.body, marginTop: 6 }}>
              Weight, age, diet and daily targets
            </Text>
          </Pressable>
          {goalsOpen && <GoalEditor extended
            profile={profile}
