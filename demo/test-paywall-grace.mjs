...
assert.equal(isInGrace(signup, new Date(2026, 5, 17, 0, 1)), true);

assert.equal(accountAgeCalendarDays(signup, new Date(2026, 5, 18, 0, 1)), 3);
assert.equal(isInGrace(signup, new Date(2026, 5, 18, 0, 1)), false);
